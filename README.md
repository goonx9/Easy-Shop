# EasyShop — Car Jump Starter One-Product E-Commerce Website
...
- **Client-Side Persistent Cart**: Lightweight cart storing selected variant and quantity in `localStorage`.
...
├── CNAME                 # Custom domain configuration (e.g., easyshop.ng)
...
1. Create a new repository on GitHub (e.g. `easyshop`).
